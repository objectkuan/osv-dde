...
drivers/virtio/%.o: COMMON += -D__KERNEL__ -D__KERN__ -D__LINUX_X86_ARCH__ -D 'KBUILD_BASENAME="virtio"' -D 'KBUILD_MODNAME="virtio"' -I$(src)/drivers/virtio/include -include linux/kconfig.h -Wno-strict-aliasing
drivers += drivers/virtio/core/virtio.o
drivers += drivers/virtio/core/virtio_mmio.o
drivers += drivers/virtio/core/virtio_pci.o
drivers += drivers/virtio/core/virtio_ring.o
drivers += drivers/virtio/core/config.o
drivers += drivers/virtio/block/virtio_blk.o
drivers += drivers/virtio/net/virtio_net.o
drivers += drivers/virtio/dummy.o
drivers += drivers/virtio/dde-misc.o
drivers += drivers/virtio/dde-lock.o drivers/virtio/dde-lock-helper.o
drivers += drivers/virtio/dde-thread.o drivers/virtio/dde-thread-helper.o
drivers += drivers/virtio/dde-memory.o drivers/virtio/dde-memory-helper.o
drivers += drivers/virtio/dde-pci.o drivers/virtio/dde-pci-helper.o
drivers += drivers/virtio/dde-block.o drivers/virtio/dde-block-helper.o
drivers += drivers/virtio/dde-net.o drivers/virtio/dde-net-helper.o
drivers += drivers/virtio/virtio.o
...
boost-libs := $(boost-lib-dir)/libboost_program_options.a \
              $(boost-lib-dir)/libboost_system.a

$(boost-tests): $(boost-lib-dir)/libboost_unit_test_framework.so \
